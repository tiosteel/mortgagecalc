...
export default function MortgageFormulaMixin<TBase extends Constructor>(Base: TBase) {
    return class MortgageFormula extends Base implements IMortgageFormula {
